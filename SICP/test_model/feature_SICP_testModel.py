...
import numpy as np
from method_whole_train_set import load_SICP_dict, CNN_1D_montage
...
def main():
    ...
    test_acc, test_label, real_label = CNN_1D_montage(SICP, X_train, y_train, X_test, y_test, lr, model_para)
